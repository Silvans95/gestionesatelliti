					...
					<form method="post"
						...
						<div class="col-md-6">
							<label for="denominazione" class="form-label">Denominazione
								...
								class="form-control" placeholder="Inserire denominazione">
						</div>

						<div class="col-md-6">
							<label for="codice" class="form-label">Codice <span
								class="text-danger">*</span></label> <input type="text" name="codice"
						...
						<div class="col-md-3">
							...
							</label> <input class="form-control" id="dataRientro" type="date"
								placeholder="dd/MM/yy" title="formato : gg/mm/aaaa"
								name="dataRientro">
						</div>
						...
						<div class="col-md-3">
							<label for="stato" class="form-label">Stato <span
								...
								<option value="INMOVIMENTO">IN MOVIMENTO</option>
